...
from apps.cash_closing.models import Income, Expense, BankAccount, Shift, Supplier
...
class IncomeAdmin(admin.ModelAdmin):
    ...
    def amount_display(self, obj):
        return format_html(
            '<span style="color:#1a7c4a;font-weight:600">${}</span>',
...
class ExpenseAdmin(admin.ModelAdmin):
    ...
    def amount_display(self, obj):
        return format_html(
            '<span style="color:#c8421a;font-weight:600">${}</span>',
            f"{float(obj.amount):,.0f}",
        )
